...
def dashBoard_view_temp1(request):
    ...
    context["data"]["persons_quarantined"] = sum([filtered_todo["Current number of non-close contacts"] for filtered_todo in filtered_todos]) + sum([filtered_todo["Current number of non-close contacts"] for filtered_todo in filtered_todos]) + sum([filtered_todo["Current number of non-close contacts"] for filtered_todo in filtered_todos]) + sum([filtered_todo["Current number of close contacts of confirmed cases"] for filtered_todo in filtered_todos])
